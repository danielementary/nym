...
pub struct ThetaRequestPhase {
    ...
    // commitments
    pub to_be_issued_commitments: Vec<G1Projective>,
    pub to_be_issued_binding_number_commitments: Vec<G1Projective>,
    pub to_be_issued_values_commitments: Vec<G1Projective>,
    pub to_be_issued_serial_numbers_commitments: Vec<G1Projective>,
